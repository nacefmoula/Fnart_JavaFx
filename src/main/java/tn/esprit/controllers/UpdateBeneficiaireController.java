...
public class UpdateBeneficiaireController implements Initializable {
    ...
    @FXML
    private void handleAddBeneficiaire(MouseEvent event) {
        // Logic to handle adding a beneficiary
        System.out.println("Add Beneficiary button clicked");
    }

    @FXML
    private void handleAddDons(MouseEvent event) {
        // Logic to handle adding a donation
        System.out.println("Add Donation button clicked");
    }

    @FXML
    private void handleListeBeneficiaire(MouseEvent event) {
        // Logic to handle listing beneficiaries
        System.out.println("List Beneficiaries button clicked");
    }
